...
export default function Warning({ value, text }) {
    return (
        <>
            {
                value && (
                    <div id="blockError" className='fixed top-[50px] left-[80px] right-0 bottom-0 bg-[#00000068] w-[100%] h-[100vh] flex flex-col items-center justify-center z-50'>
                        <div className=' bg-c2 p-8 flex flex-col items-center justify-center rounded-xl'>
                            <span className='w-full flex justify-center text-red-600'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" className="bi bi-exclamation-triangle" viewBox="0 0 16 16">
