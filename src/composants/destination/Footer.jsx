                        ...
                        <div className='max-lg:px-4 max-md:w-[100%] max-lg:w-[50%] lg:w-3/12'>
                            ...
                            <h6 className='px-2 pt-4 text-white flex'>
                                <span className='text-c1'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="28" fill="currentColor" className="bi bi-envelope-fill" viewBox="0 0 16 16">
                            ...
                            <h6 className='px-2 pt-4 text-white flex'>
                                <span className='text-c1'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="28" fill="currentColor" className="bi bi-telephone-fill" viewBox="0 0 16 16">
