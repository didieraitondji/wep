            ...
            <div className='w-[80%] mx-auto z-0'>
                ...
                <div className='flex flex-row font-poppins max-lg:flex-wrap'>
                    <div className='px-5 py-4 border border-c1 w-1/4 max-lg:w-2/4 max-sm:w-[100%]'>
                        <div className='text-start'>
                            <span className='w-[70px] h-[70px] flex flex-col items-center justify-center rounded-sm bg-c3 text-c1 font-bold '>
                                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
                    ...
                    <div className='px-5 py-4 border border-c1 w-1/4 max-lg:w-2/4 max-sm:w-[100%]'>
                        <div className='text-start'>
                            <span className='w-[70px] h-[70px] flex flex-col items-center justify-center rounded-sm bg-c3 text-c1 font-bold'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" className="bi bi-database-fill-down" viewBox="0 0 16 16">
                    ...
                    <div className='px-5 py-4 border border-c1 w-1/4 max-lg:w-2/4 max-sm:w-[100%]'>
                        <div className='text-start'>
                            <span className='w-[70px] h-[70px] flex flex-col items-center justify-center rounded-sm bg-c3 text-c1 font-bold'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" className="bi bi-journal-code" viewBox="0 0 16 16">
                    ...
                    <div className='px-5 py-4 border border-c1 w-1/4 max-lg:w-2/4 max-sm:w-[100%]'>
                        <div className='text-start'>
                            <span className='w-[70px] h-[70px] flex flex-col items-center justify-center rounded-sm bg-c3 text-c1 font-bold'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" className="bi bi-chat-fill" viewBox="0 0 16 16">
