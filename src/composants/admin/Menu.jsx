...
export default function MenuAdmin({ page }) {
    return (
        <>
            ...
            <div className='w-[100%] pt-[30px] pb-[40px] flex flex-col space-y-6 h-[100%] overflow-auto'>
                <a href='/admin/dashboard/' className={`flex flex-col items-center justify-center text-c1 cursor-pointer pt-2 px-2 rounded-md hover:bg-gray-500 my-2 ${page == "accueil" ? "bg-gray-500" : "bg-gray-700"}`} title='Tableau de bord'>
                ...
                <a href='/admin/tps/' className={`flex flex-col items-center justify-center text-c1 cursor-pointer pt-2 px-2 rounded-md hover:bg-gray-500 my-2 ${page == "tps" ? "bg-gray-500" : "bg-gray-700"}`} title='Voir les TPs'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-file-ppt-fill" viewBox="0 0 16 16">
                ...
                <a href='/admin/travaux/' className={`flex flex-col items-center justify-center text-c1 cursor-pointer pt-2 px-2 rounded-md hover:bg-gray-500 my-2 ${page == "travaux" ? "bg-gray-500" : "bg-gray-700"}`} title='Voir les soumissions'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-file-easel-fill" viewBox="0 0 16 16">
                ...
                <a href='/admin/users/' className={`flex flex-col items-center justify-center text-c1 cursor-pointer pt-2 px-2 rounded-md hover:bg-gray-500 my-2 ${page == "utilisateurs" ? "bg-gray-500" : "bg-gray-700"}`} title='Gérer les utilisateurs'>
