...
export default function BarniereAc() {
  return (
    <div className="min-h-[98vh] bg-[url('/images/baniere4.jpg')] max-md:bg-center bg-no-repeat bg-cover">
      <div className="w-full min-h-[98vh] bg-[rgba(0,0,255,0.4)] flex items-center justify-center ">
        <div className="m-4 pb-4 pl-20 border-l-8">
          ...
          <div className="my-5 flex gap-4 font-mono flex-wrap">
            <a
              href="/connexion/"
              className="py-2 px-10 bg-orange-400 text-white rounded hover:bg-blue-400 font-bold"
            >
              Se Connecter
            </a>
          </div>
