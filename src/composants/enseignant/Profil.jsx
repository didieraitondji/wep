...
export default function Profil() {
    ...
    useEffect(() => {
        loadGetData(`ecuesenseignant/${userData.id}`, setEcus);
    }, []);
                            ...
                            <div className='px-3 py-3 pb-4 flex flex-col'>
                                <table className='w-full border border-c3'>
                                    ...
                                    <tbody>
                                        {
                                            ecus.map((item, index) => (
                                                <tr key={item.id} className={`${(index % 2) == 0 ? "" : "bg-c2"}`}>
                                                    <td className='py-2 px-1 text-center'>{index + 1}</td>
                                                    <td className='py-2 px-1'>{item.ename}</td>
                                                    <td className='py-2 px-1'>{item.uname}</td>
                                                    <td className='py-2 px-1'>{item.fname}</td>
                                                </tr>
                                            ))
                                        }
                                    </tbody>
