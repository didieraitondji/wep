...
export default function MenuEtudiant({ page }) {
    return (
        <>
            ...
            <div className='w-[100%] pt-[30px] pb-[40px] flex flex-col space-y-6 h-[100%] overflow-auto'>
                <a href='/etudiant/dashboard/' className={`flex flex-col items-center justify-center text-c1 cursor-pointer pt-2 px-2 rounded-md hover:bg-gray-500 my-2 ${page == "accueil" ? "bg-gray-500" : "bg-gray-700"}`} title='Tableau de bord'>
                ...
                <a href='/etudiant/tps/' className={`flex flex-col items-center justify-center text-c1 cursor-pointer pt-2 px-2 rounded-md hover:bg-gray-500 my-2 ${page == "tps" ? "bg-gray-500" : "bg-gray-700"}`} title='Voir les TPs'>
                ...
                <a href='/etudiant/travaux/' className={`flex flex-col items-center justify-center text-c1 cursor-pointer pt-2 px-2 rounded-md hover:bg-gray-500 my-2 ${page == "travaux" ? "bg-gray-500" : "bg-gray-700"}`} title='Voir les soumissions'>
