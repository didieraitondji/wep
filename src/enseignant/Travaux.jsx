...
export default function TravauxEnseignant() {
    document.getElementsByTagName("title")[0].innerHTML = "Soumissions | Enseignant";
        ...
        <>
            <div className='font-poppins'>
                <div className='bg-c3 fixed left-0 top-0 bottom-0 w-[80px] px-2 py-2'>
                    <MenuEnseignant page={"travaux"} />
                </div>
                <div className='bg-c1 fixed left-[80px] right-0 top-0 h-[54px]'>
                    <TopBarEnseignant text={"Gérer les Soumissions"} prenom={userData.firstName} />
                </div>
