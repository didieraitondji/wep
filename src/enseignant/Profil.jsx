...
import Profil from '../composants/enseignant/Profil';

export default function ProfilEnseignant() {
    document.getElementsByTagName("title")[0].innerHTML = "Profil | Enseignant";
        ...
        <>
            <div className='font-poppins'>
                <div className='bg-c1 fixed left-[80px] right-0 top-0 h-[54px]'>
                    <TopBarEnseignant text={"Profil Personel"} prenom={userData.firstName} />
                </div>
